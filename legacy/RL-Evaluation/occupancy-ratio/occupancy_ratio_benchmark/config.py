...
class OccupancyRatioBenchmarkConfig:
    ...
    neural_num_iterations: int = 30
    neural_gradient_steps_per_iteration: int = 4
    ...
    neural_action_steps: int = 400
    neural_transition_steps: int = 600
        ...
        *,
        ...
        if stage == "overnight":
            return cls(
                ...
                neural_mcmc_samples=48,
                neural_action_steps=900,
                neural_transition_steps=1_200,
                google_num_updates=5_000,
                mc_truth_samples=80_000,
                gym_target_value_rollouts=48,
                estimator_timeout_sec=600.0,
            )
