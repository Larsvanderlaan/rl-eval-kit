"""Deprecated compatibility namespace for legacy IRL modules."""
...
warnings.warn(
    "The `IRL` namespace is deprecated; legacy implementations now live under `legacy.IRL`.",
    DeprecationWarning,
    stacklevel=2,
)
...
def __getattr__(name: str):
    if name in __all__:
        module = import_module("experiments.irl.journal_debiased_irl.jrssb_simulation")
